<template>
  <div class="vuestic-data-table-user table-responsive"
...
import DetailRow from './datatable-components/DetailRow'

Vue.component('my-detail-row', DetailRow)

export default {
  name: 'vuestic-data-table-user',
  components: {
    SpringSpinner,
    FilterBar,
    Vuetable,
  ...
  methods: {
    ...
    trueLabel: function (value) {
      return value === true
        ? '<span class="alert alert-success" role="alert">Ano</span>' : '<span class="alert alert-danger" role="alert">Ne</span>'
    }
  }
}
</script>
